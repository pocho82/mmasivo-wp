...
function loads_scripts(){
    wp_enqueue_script( 'vendors_js', get_template_directory_uri() . '/js/vendors.min.js', array( 'jquery' ), time(), true );
    wp_enqueue_script( 'main_js', get_template_directory_uri() . '/js/main.min.js', array( 'jquery', 'vendors_js' ), null, true );
}
