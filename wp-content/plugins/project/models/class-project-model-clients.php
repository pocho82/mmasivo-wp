...
class Project_Model_Clients{
    ...
    function __construct( $template_parser ) {
        ...
        $this->post_type_name = 'mmasivo-clients';
        $this->post_type_singular = __('Client', 'mmasivo');
        $this->post_type_plural = __('Clients', 'mmasivo');
        $this->menu_icon = 'dashicons-networking';
    ...
    function create_post_type(){
        ...
        $args = array(
            'labels' => $labels,
            'description'         => __( 'Clients of the company', 'mmasivo'),
