...
class Project_Model_Projects{
    ...
    function __construct( $template_parser ) {
        ...
        $this->post_type_name = 'mmasivo-projects';
        $this->post_type_singular = __('Project', 'mmasivo');
        $this->post_type_plural = __('Projects', 'mmasivo');

        $this->request_type_taxonomy = 'types_projects';
        $this->request_type_taxonomy_singular = __('Category','mmasivo');
        $this->request_type_taxonomy_plural = __('Categories','mmasivo');
    ...
    function create_post_type(){
        ...
        $args = array(
            'labels' => $labels,
            'description'         => __( 'Projects done', 'mmasivo'),
    ...
    function metabox_projects(){
        ...
        $cmb->add_field( array(
          'name'    => __( 'Gallery Header', 'mmasivo' ),
          'id'      => $prefix . 'gallery',
          'type'    => 'file_list',
      ) );
    }
